...
func builtinTypeof(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
...
func builtinTostr(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
func builtinToint(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
func builtinTofloat(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
// toliteral(value) -> str
func builtinToliteral(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
func builtinToobj(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
func builtinEqual(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 2 {
		return types.Err(types.E_ARGS)
	}
