...
func builtinLength(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
...
func builtinStrsub(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
func builtinIndex(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
func builtinRindex(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) < 2 || len(args) > 4 {
		return types.Err(types.E_ARGS)
	}
...
func builtinStrcmp(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 2 {
		return types.Err(types.E_ARGS)
	}
...
// upcase(str) -> str
func builtinUpcase(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
// downcase(str) -> str
func builtinDowncase(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
// capitalize(str) -> str
func builtinCapitalize(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
func builtinExplode(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
func builtinImplode(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
// trim(str [, chars]) -> str
func builtinTrim(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) < 1 || len(args) > 2 {
		return types.Err(types.E_ARGS)
	}
...
// ltrim(str [, chars]) -> str
func builtinLtrim(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) < 1 || len(args) > 2 {
		return types.Err(types.E_ARGS)
	}
...
// rtrim(str [, chars]) -> str
func builtinRtrim(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) < 1 || len(args) > 2 {
		return types.Err(types.E_ARGS)
	}
...
func builtinStrtr(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) < 3 || len(args) > 4 {
		return types.Err(types.E_ARGS)
	}
...
func builtinMatch(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
func builtinRmatch(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) < 2 || len(args) > 3 {
		return types.Err(types.E_ARGS)
	}
...
func builtinSubstitute(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 2 {
		return types.Err(types.E_ARGS)
	}
