...
func builtinQueuedTasks(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) > 2 {
...
func builtinKillTask(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 1 {
		return types.Err(types.E_ARGS)
	}
...
func builtinSuspend(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) > 1 {
		return types.Err(types.E_ARGS)
	}
...
// Requires permission: must be task owner or wizard
func builtinResume(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
func builtinSetTaskPerms(ctx *runtime.TaskContext, args []types.Value) types.Result {
	store := ctx.Store
...
func builtinCallerPerms(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) != 0 {
		return types.Err(types.E_ARGS)
	}
...
func builtinCallers(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) > 1 {
		return types.Err(types.E_ARGS)
	}
...
func evalWrapperFrames(ctx *runtime.TaskContext, includeLineNumbers bool) []types.Value {
...
func evalUserCodeFrame(ctx *runtime.TaskContext, includeLineNumbers bool) types.Value {
	base := []types.Value{
...
func syntheticEvalCallers(ctx *runtime.TaskContext, includeLineNumbers bool) types.Value {
...
func builtinRaise(ctx *runtime.TaskContext, args []types.Value) types.Result {
...
func builtinTaskStack(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) < 1 || len(args) > 2 {
		return types.Err(types.E_ARGS)
	}
...
func builtinYin(ctx *runtime.TaskContext, args []types.Value) types.Result {
	if len(args) > 3 {
		return types.Err(types.E_ARGS)
	}
