...
func (v Value) Equal(other Value) bool {
	...
	case TYPE_OBJ, TYPE_ANON:
		// Old ObjValue.Equal compared ids only and matched any ObjValue, so a
		// regular and an anonymous reference with the same id were equal.
		return (other.tag == TYPE_OBJ || other.tag == TYPE_ANON) && v.n == other.n
	case TYPE_ERR:
