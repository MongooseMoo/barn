...
func (c *Compiler) compileTryExcept(n *verb.TryExceptStmt) error {
	// Bytecode layout:
...
func (c *Compiler) compileTryFinally(n *verb.TryFinallyStmt) error {
	// Bytecode layout:
...
func (c *Compiler) compileTryExceptFinally(n *verb.TryExceptFinallyStmt) error {
