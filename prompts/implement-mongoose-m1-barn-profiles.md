...
- Mongoose fixture: `C:/Users/Q/code/barn/mongoose.db`, 100,959,239 bytes, SHA-256 `a9d167861eab56d62e9bd12ae1d47c5e6a858530020a5dcf174a0b104fb23db9`.
...
4. Add immutable oracle manifests under `profiles/toast/` using the existing Barn manifest field vocabulary:
   ...
   - `mongoose-wsl-mongoose.json` for `mongoose.db`, the Mongoose implementation/options identity, `runtime_os: linux`, `arch_bits: 64`, `option.OUTBOUND_NETWORK: true`, and `option.PROMOTE_NUMBERS: true`.
